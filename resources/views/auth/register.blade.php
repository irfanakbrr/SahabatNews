  ...
  <div id="card" class="relative mx-auto my-auto w-full max-w-md shrink-0 overflow-hidden rounded-4xl border-t border-white/20 bg-gradient-to-t from-zinc-100/10 to-zinc-950/50 to-50% p-8 text-white shadow-2xl shadow-black outline -outline-offset-1 outline-white/5 backdrop-blur-2xl">
    ...
    @if ($errors->any())
        <div id="error-notification" class="mb-4 p-4 bg-red-500/20 border border-red-500/50 rounded-lg backdrop-blur-sm">
            <div class="flex items-center">
                ...
                <div>
                    <h4 class="text-red-300 font-semibold">Registrasi Gagal!</h4>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="flex grid-cols-2 flex-col gap-4 text-sm sm:grid">
            ...
            <div class="relative h-11 overflow-hidden">
                <input 
                    ...
                    autofocus
                    autocomplete="name"
                    class="peer relative z-1 h-full w-full rounded-md border border-white/8 bg-white/5 px-4 duration-300 placeholder:text-white/50 focus:outline-0 focus:bg-white/10 text-white font-semibold focus:text-white @error('name') border-red-500/50 bg-red-500/10 @enderror" 
            ...
            <div class="relative h-11 overflow-hidden">
                <input 
                    ...
                    name="username"
                    value="{{ old('username') }}"
                    class="peer relative z-1 h-full w-full rounded-md border border-white/8 bg-white/5 px-4 duration-300 placeholder:text-white/50 focus:outline-0 focus:bg-white/10 text-white font-semibold focus:text-white @error('username') border-red-500/50 bg-red-500/10 @enderror" 
            ...
            <div class="relative col-span-2 h-11 overflow-hidden">
                <input 
                    ...
                    name="phone"
                    value="{{ old('phone') }}"
                    class="peer relative z-1 h-full w-full rounded-md border border-white/8 bg-white/5 pr-4 pl-11 duration-300 placeholder:text-white/50 focus:outline-0 focus:bg-white/10 text-white font-semibold focus:text-white @error('phone') border-red-500/50 bg-red-500/10 @enderror" 
            ...
            <div class="relative col-span-2 h-11 overflow-hidden">
                <input 
                    ...
                    class="peer relative z-1 h-full w-full rounded-md border border-white/8 bg-white/5 px-4 duration-300 placeholder:text-white/50 focus:outline-0 focus:bg-white/10 text-white font-semibold focus:text-white @error('password') border-red-500/50 bg-red-500/10 @enderror" 
            ...
            <div class="relative col-span-2 h-11 overflow-hidden">
                <input 
                    ...
                    required
                    autocomplete="new-password"
                    class="peer relative z-1 h-full w-full rounded-md border border-white/8 bg-white/5 px-4 duration-300 placeholder:text-white/50 focus:outline-0 focus:bg-white/10 text-white font-semibold focus:text-white @error('password_confirmation') border-red-500/50 bg-red-500/10 @enderror" 
        ...
        <div class="flex items-center justify-between mt-6">
            <a class="text-sm text-white/60 hover:text-white transition-colors" href="{{ route('login') }}">
                {{ __('Already registered?') }}
            </a>

            <button type="submit" class="h-10 px-6 cursor-pointer rounded-md bg-white text-sm font-semibold text-zinc-800 shadow-xl hover:bg-gray-100 transition-colors">
                {{ __('Register') }}
            </button>
        </div>
    </form>
